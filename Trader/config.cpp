...
//'now' is Mon Aug 10 06:55:04 2020 : 'file' last modified on Sun Aug 09 21:44:41 2020
////////////////////////////////////////////////////////////////////
	...
	class MoneyRuble1: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1,{"TM\Trader\data\ruble.rvmat"}},{0.7,{"TM\Trader\data\ruble.rvmat"}},{0.5,{"TM\Trader\data\ruble_damage.rvmat"}},{0.3,{"TM\Trader\data\ruble_damage.rvmat"}},{0,{"TM\Trader\data\ruble_destruct.rvmat"}}};
				};
			};
		};
	};
	...
	class VehicleKeyBase: Inventory_Base
	{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1,{"TM\Trader\data\keyLada.rvmat"}},{0.7,{"TM\Trader\data\keyLada.rvmat"}},{0.5,{"TM\Trader\data\keyLada_damage.rvmat"}},{0.3,{"TM\Trader\data\keyLada_damage.rvmat"}},{0,{"TM\Trader\data\keyLada_destruct.rvmat"}}};
				};
			};
		};
	};
